...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden font-sans selection:bg-primary/30" ref={containerRef}>
      <Helmet>
        <title>About | CodeQuity - India's Web3 Foundry</title>
        <meta name="description" content="Uncovering the mission, vision, and team behind India's premier Web3 startup foundry." />
      </Helmet>
      <Navigation />
      <div className="min-h-screen bg-black overflow-x-hidden font-sans selection:bg-primary/30" ref={containerRef}>
        <Helmet>
