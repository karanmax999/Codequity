...
export default function Community() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden font-sans selection:bg-primary/30" ref={heroRef}>
      <Helmet>
        <title>Community | Join the CodeQuity Guild</title>
        <meta name="description" content="Join 500+ builders in the official CodeQuity community. Collaborative shipping, networking, and growth." />
      </Helmet>
      <Navigation />
